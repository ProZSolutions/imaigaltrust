...
export default function EventsPage() {
  ...
  const formatTimeIST = (dateTime: any) => {
    if (!dateTime) return "-";
    ...
    <div className="space-y-6 w-full min-w-0">
      ...
      <div className="md:hidden space-y-4">
        {paginatedEvents.map((event) => (
          <div key={event.id} className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2 text-[11px] text-gray-600">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-gray-400 w-16">Program:</span>
                <span className="truncate">{event.program}</span>
              </div>
              <div className="flex items-center gap-2">
