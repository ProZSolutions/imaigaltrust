        ...
        <div className="w-full overflow-x-auto rounded-lg border border-gray-100">
          <table className="w-full min-w-[620px] text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-50">
              {fetching ? (
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-gray-600 whitespace-nowrap">
                ...
                <tr>
                  <td colSpan={7} className="px-4 py-20 text-center text-gray-500 font-medium">
              ...
              <form onSubmit={handleSubmit} suppressHydrationWarning className="p-8 space-y-6 overflow-y-auto max-h-[calc(100vh-220px)]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full px-5 py-3.5 border rounded-2xl ${errors.programId ? "border-red-500" : "border-gray-200"
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full px-5 py-3.5 border rounded-2xl ${errors.categoryId ? "border-red-500" : "border-gray-200"
                          } focus:ring-4 focus:ring-[#096412]/5 focus:border-[#096412] outline-none transition-all appearance-none bg-white font-semibold text-sm shadow-sm`}
                      >
                  ...
                  <div className="space-y-2.5">
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-3.5 border rounded-2xl ${errors.year ? "border-red-500" : "border-gray-200"
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full px-5 py-3.5 border rounded-2xl ${errors.month ? "border-red-500" : "border-gray-200"
                          } focus:ring-4 focus:ring-[#096412]/5 focus:border-[#096412] outline-none transition-all appearance-none bg-white font-semibold text-sm shadow-sm`}
                      >
                ...
                <div className="space-y-2.5">
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-3.5 border rounded-2xl ${errors.title ? "border-red-500" : "border-gray-200"
                      } focus:ring-4 focus:ring-[#096412]/5 focus:border-[#096412] outline-none transition-all font-semibold text-sm shadow-sm`}
                  />
                  {errors.title && (
                    <p className="text-red-500 mt-1 ml-1 text-xs">
                ...
                <div className="space-y-2.5">
                  ...
                  <textarea
                    ...
                    className={`w-full px-5 py-3.5 border rounded-2xl ${errors.description ? "border-red-500" : "border-gray-200"
                ...
                <div className="space-y-2">
                  ...
                  {formData.mediaType === "image" ? (
                    <div
                      ...
                      className={`border-2 border-dashed rounded-[2rem] p-10 text-center transition-all cursor-pointer group ${errors.file
                          ? "border-red-500"
                          : selectedFile
